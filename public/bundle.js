...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_Main2.default, { source: '/api/beers' }), document.getElementById('app'));
	...
	var Main = function (_React$Component) {
	  ...
	  _createClass(Main, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      fetch(new Request(this.props.source)).then(function (response) {
	        if (response.ok) {
